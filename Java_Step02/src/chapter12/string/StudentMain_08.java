...
public class StudentMain_08 {
	...
	public static void main(String[] args) {
		...
		if(studentLee == studentLee2) { //물리적인, 저장되어있는 주소
			System.out.println("studentLee 와 studentLee2 주소는 같습니다.");
		}else {
			System.out.println("studentLee 와 studentLee2 주소는 다릅니다.");
		}
		...
		if(studentLee == studentSang) { //물리적인, 저장되어있는 주소
			System.out.println("studentLee 와 studentSang 주소는 같습니다.");
		}else {
			System.out.println("studentLee 와 studentSang 주소는 다릅니다.");
		}
